      ...
      <main className="grow flex flex-col md:flex-row h-full overflow-hidden">
        ...
        <div className="hidden md:block w-1/2 bg-[#0e0e0e] border-r border-[#444748]/30 h-full relative overflow-hidden">
          <img
            ...
            src="https://lh3.googleusercontent.com/aida-public/AB6AXuDYgeemKKoeXBBBu4SLgl7Xtl7N5DYfDNsbxXm5aom-sIA0Fb9CwUFB4KWtlBJVt53fshy500i-jZbewEJXdfG2Q0dBkUrXe7OOALY8fv4rEKksBwnP5iWpfaFImluhUE8orKxbBVSTARR3hSJpGC4DrgHNdm3Oyc-MR39i031FBiVlCsnQAARxrJrpTISLghl5TfbjzwsERNd_h3i-knoQllcaW31JSG0hMtVr_EP4EUDV1hbHSI0C"
          />
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center p-6 md:p-12 bg-[#0d0d0d] relative overflow-y-auto h-full">
          <div className="w-full max-w-md space-y-8 z-10 my-auto">
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              ...
              <button
                type="submit"
                className="w-full bg-[#c9c6c5] text-[#0d0d0d] text-[12px] leading-4 tracking-widest font-bold py-4 rounded-none flex items-center justify-between px-6 hover:bg-[#c7c9a3] transition-colors duration-300 group cursor-pointer"
                style={{ fontFamily: "'Space Grotesk', sans-serif" }}
              >
                <span>CONTINUE</span>
